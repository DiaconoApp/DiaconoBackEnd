...
('50000000-0000-0000-0000-000000000001', 1, 1, NULL, 'Culto da Família', 'Celebração principal de domingo', 'Toda a Família', '2025-05-12 18:00:00', '2025-05-12 20:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000002', 1, 6, NULL, 'Sábado Jovem', 'Encontro da juventude com muito louvor', 'Jovens', '2025-05-18 19:30:00', '2025-05-18 21:30:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000003', 1, 4, NULL, 'Tarde da Alegria', 'Brincadeiras e palavra para as crianças', 'Crianças 2-10 anos', '2025-05-25 14:00:00', '2025-05-25 17:00:00', 10.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000004', 1, 1,  NULL, 'Acampamento Renascer', 'Retiro anual de carnaval', 'Geral', '2025-02-10 08:00:00', '2025-02-13 12:00:00', 350.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000005', 1, 5, NULL, 'Workshop de Transmissão', 'Treinamento para equipe de vídeo', 'Voluntários Tech', '2025-06-01 09:00:00', '2025-06-01 12:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000006', 1, 2,  NULL, 'Ide pelas Praças', 'Evangelismo e ação social no parque', 'Aberto', '2025-06-15 10:00:00', '2025-06-15 13:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000007', 1, 2, NULL, 'Vigília da Virada', 'Oração pela madrugada', 'Intercessores', '2025-07-01 23:00:00', '2025-07-02 03:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000008', 1, 8, NULL, 'Café de Boas Vindas', 'Recepção para novos visitantes', 'Visitantes', '2025-05-12 10:00:00', '2025-05-12 11:30:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000009', 1, 1,  NULL, 'Retiro de Verão: Profundidade', 'Foco em oração e aprofundamento bíblico', 'Geral', '2026-01-17 18:00:00', '2026-01-20 16:00:00', 400.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000010', 1, 15, NULL, 'Reunião dos Diáconos', 'Planejamento e coordenação de serviços', 'Diáconos', '2026-01-29 20:00:00', '2026-01-29 21:30:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000011', 1, 10, NULL, 'Culto de Missões', 'Foco em evangelismo transcultural', 'Geral', '2026-02-09 18:00:00', '2026-02-09 20:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000012', 1, 18, NULL, 'Noite do Cinema Kids', 'Filme e pipoca para a criançada', 'Crianças', '2026-02-22 19:00:00', '2026-02-22 21:00:00', 5.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000013', 1, 12, NULL, 'Treinamento para Novos Membros', 'História e doutrina da igreja', 'Novos Membros', '2026-03-08 09:00:00', '2026-03-08 13:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000014', 1, 14,  NULL, 'Jantar de Casais: Renovação', 'Palestra e jantar especial para casais', 'Casais', '2026-03-29 20:00:00', '2026-03-29 23:00:00', 120.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000015', 1, 6, NULL, 'Culto Especial de Páscoa', 'Celebração da Ressurreição', 'Geral', '2026-04-05 18:00:00', '2026-04-05 20:30:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000016', 1, 7, NULL, 'Estudo Bíblico Semanal', 'Estudo aprofundado do livro de Atos', 'Geral', '2026-05-07 20:00:00', '2026-05-07 21:30:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000017', 1, 2, NULL, 'Chá de Oração das Mulheres', 'Momento de comunhão e intercessão feminina', 'Mulheres', '2026-05-24 16:00:00', '2026-05-24 18:00:00', 15.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000018', 1, 11, NULL, 'Reunião de Líderes de Célula', 'Capacitação e alinhamento da visão', 'Líderes de Célula', '2026-06-04 20:00:00', '2026-06-04 21:30:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000019', 1, 3,  NULL, 'Conferência de Louvor e Adoração', 'Palestra e prática para músicos e vocalistas', 'Equipes de Louvor', '2026-07-04 19:00:00', '2026-07-06 21:00:00', 80.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000020', 1, 9, NULL, 'Dia do Amigo Kids', 'Convite especial para os amiguinhos das crianças', 'Crianças e Convidados', '2026-07-19 14:00:00', '2026-07-19 17:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000021', 1, 1, NULL, 'Semana de Santa Ceia', 'Momentos devocionais e Ceia do Senhor', 'Membros Batizados', '2026-08-06 20:00:00', '2026-08-06 21:30:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000022', 1, 13,  NULL, 'Feira Vocacional Cristã', 'Orientação sobre carreira e vocação', 'Jovens e Adolescentes', '2026-08-23 09:00:00', '2026-08-23 17:00:00', 25.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000023', 1, 5, NULL, 'Atualização de Software e Streaming', 'Treinamento de novas ferramentas multimídia', 'Voluntários Tech', '2026-09-13 09:00:00', '2026-09-13 12:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000024', 1, 16, NULL, 'Culto de Ação de Graças', 'Celebração pela colheita e provisão de Deus', 'Geral', '2026-10-12 18:00:00', '2026-10-12 20:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000025', 1, 17, NULL, 'Campanha de Arrecadação de Roupas', 'Arrecadação para famílias carentes', 'Aberto', '2026-10-25 09:00:00', '2026-10-25 14:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000026', 1, 4, NULL, 'Festa do Dia das Crianças', 'Celebração com gincanas e doces', 'Crianças', '2026-11-01 15:00:00', '2026-11-01 18:00:00', 5.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000027', 1, 8, NULL, 'Treinamento de Acolhimento', 'Capacitação para equipe de recepção', 'Voluntários de Recepção', '2026-11-22 09:00:00', '2026-11-22 12:00:00', 0.00, 'ESCALADO'),
('50000000-0000-0000-0000-000000000028', 1, 1, NULL, 'Ceia de Natal Comunitária', 'Celebração e confraternização de Natal', 'Geral', '2026-12-24 21:00:00', '2026-12-24 23:30:00', 50.00, 'ESCALADO');
