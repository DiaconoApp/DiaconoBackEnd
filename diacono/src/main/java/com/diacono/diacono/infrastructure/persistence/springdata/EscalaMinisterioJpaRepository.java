...
public interface EscalaMinisterioJpaRepository extends JpaRepository<EscalaMinisterio, Long> {
    ...
    @Query("""
            SELECT new com.diacono.diacono.infrastructure.persistence.projection.EscalaMinisterioConsolidadoQueryResult(
                e.idExterno,
                ee.idExterno,
                e.nome,
                m.nome,
    ...
    @Query("""
            SELECT new com.diacono.diacono.infrastructure.persistence.projection.EscalaMinisterioQueryResult(
                e.idExterno,
                em.idExterno,
                e.nome,
                mi.nome,
    ...
    @Query("""
            SELECT new com.diacono.diacono.infrastructure.persistence.projection.EscalaMembroMinisterioQueryResult(
                mm.idExterno,
                m.nome,
                em.statusEscalaMinisterio,
                null
